...
$DonorIndice = new BloodDonorStore();

if(isset($_REQUEST['list'])) {
    $list = 1;
    $recordSet = $DonorIndice->index();

}
else {
    $list= 0;
    $DonorIndice->setData($_REQUEST);
    $singleItem = $DonorIndice->view();
}
...
<div class="container">
    ...
    <form  role="form" method="post" action="email.php<?php if(isset($_REQUEST['id'])) echo "?id=".$_REQUEST['id']; else echo "?list=1";?>">
        <div class="form-group">
            ...
            <input type="text"  name="subject"  class="form-control" id="subject" value="<?php if($list){echo "List of Donors we currently have";} else {echo "A single Donor Information";} ?>">
...
if($list){
    ...
    printf("<table><tr><td width='50'><strong>Serial</strong></td><td width='50'><strong>Donor ID</strong></td><td width='250'><strong>Username</strong></td><td width='250'><strong>Blood Group</strong></td><td width='250'><strong>Phone No.</strong></td></tr>");
    ...
    foreach($recordSet as $row) {
        ...
        $sl++;
        printf("<tr><td width='50'>%d</td><td width='50'>%d</td><td width='250'>%s</td><td width='250'>%s</td><td width='250'>%s</td></tr>",$sl,$id,$username,$BloodGroup,$phone);
...
{
    printf("I'm recommending You: [<strong>Donor ID: </strong>%s, <strong>User Name: </strong>%s, <strong>Blood Group: </strong>%s, <strong>Phone No: </strong>%s]",$singleItem->id,$singleItem->user_name,$singleItem->blood_group,$singleItem->phone);
